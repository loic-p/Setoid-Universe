...
Definition sym1_pre (A B : U1) {a : El1 A} {b : El1 B} : sand (eq1 A B a b -> eq1 B A b a) (eq1 B A b a -> eq1 A B a b).
Proof.
...
Definition symU1_pre (A B : U1) : sand (eqU1 A B -> eqU1 B A) (eqU1 B A -> eqU1 A B).
Proof.
